...
![Code size](https://img.shields.io/github/languages/code-size/Kaden5480/poy-freecam?color=5c85d6)
![Open issues](https://img.shields.io/github/issues/Kaden5480/poy-freecam?color=d65c5c)
![License](https://img.shields.io/github/license/Kaden5480/poy-freecam?color=a35cd6)

A configurable freecam mod for
...
[here](https://github.com/Kaden5480/poy-freecam/releases).
...
## Visual Studio build
To build with Visual Studio, open `Freecam.sln` and build by pressing ctrl + shift + b,
